        ...
        <v-container fluid>
          ...
          <v-row class="mb-12" v-if="n === 1">
            ...
            <v-row justify="center">
              <v-col v-for="(checkbox, index) in chexbox[n]" :key="index" cols="6" sm="6">
                <v-checkbox v-model="ex4" :label="checkbox" :value="checkbox" hide-details class="ml-12"></v-checkbox>
              </v-col>
            </v-row>
          </v-row>
          <!-- Карман -->
          ...
          <v-row class="mb-12" v-if="n === 5">
            <v-col v-for="color in colors" :key="color" cols="12" sm="3">
              <v-checkbox v-model="ex4" :label="color" :color="color" :value="color" hide-details></v-checkbox>
            </v-col>
          </v-row>
          <!-- Размер -->
          <v-row v-if="n === 6">
